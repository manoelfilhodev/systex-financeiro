<div class="grid gap-5 sm:grid-cols-2">
    ...
    <div>
        ...
        @error('data_lancamento') <p class="mt-2 text-sm font-semibold text-red-300">{{ $message }}</p> @enderror
    </div>
</div>
...
<div>
    ...
    @error('descricao') <p class="mt-2 text-sm font-semibold text-red-300">{{ $message }}</p> @enderror
</div>
...
<div class="grid gap-5 sm:grid-cols-2">
    <div>
        ...
        @error('valor') <p class="mt-2 text-sm font-semibold text-red-300">{{ $message }}</p> @enderror
    </div>
    ...
    <div>
        ...
        @error('categoria_id') <p class="mt-2 text-sm font-semibold text-red-300">{{ $message }}</p> @enderror
    </div>
</div>
...
<div>
    ...
    @error('observacao') <p class="mt-2 text-sm font-semibold text-red-300">{{ $message }}</p> @enderror
</div>
